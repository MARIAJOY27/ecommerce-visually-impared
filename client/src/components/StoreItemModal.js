              ...
              <div className="flex mt-4">
                ...
                >
                  <input
                    ...
                    className="leading-normal w-16 flex-1 border h-10 rounded rounded-r-none px-3 relative"
                  />
                  <button
                    type="submit"
                    className="flex text-white rounded-l-none border-0 py-2 px-3 focus:outline-none rounded bg-btn-custom" 
                    style={{background: '#1a9df8'}}
                  >
                    Add To Cart
                  </button>
                </form>
